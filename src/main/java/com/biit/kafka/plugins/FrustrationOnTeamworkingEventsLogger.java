 ...
 */
public class FrustrationOnTeamworkingEventsLogger extends BiitLogger {

    private static final Logger LOGGER = LoggerFactory.getLogger(FrustrationOnTeamworkingEventsLogger.class);
